            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <h1 class="text-2xl font-bold text-primary-600">Digital Arsip</h1>
                    </div>
                    <div class="flex items-center">
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:text-center" data-aos="fade-up">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        Nikmati berbagai fitur canggih untuk mengelola arsip digital Anda
                    </p>
                </div>
                <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                    <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                        <div class="flex flex-col" data-aos="fade-up" data-aos-delay="100">
                            <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                                <svg class="h-5 w-5 flex-none text-primary-600" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <path d="M5 8.75v-2.5a.75.75 0 00-1.5 0v2.5a.75.75 0 001.5 0zM16.5 6.25v2.5a.75.75 0 01-1.5 0v-2.5a.75.75 0 011.5 0zM4.25 15h11.5a.75.75 0 000-1.5H4.25a.75.75 0 000 1.5z"/>
                                </svg>
                                Pengarsipan Digital
                            </dt>
                        ...
                        <div class="flex flex-col" data-aos="fade-up" data-aos-delay="200">
                            <dt class="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                                <svg class="h-5 w-5 flex-none text-primary-600" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <path fill-rule="evenodd" d="M4.5 2A1.5 1.5 0 003 3.5v13A1.5 1.5 0 004.5 18h11a1.5 1.5 0 001.5-1.5V7.621a1.5 1.5 0 00-.44-1.06l-4.12-4.122A1.5 1.5 0 0011.378 2H4.5zm2.25 8a2.5 2.5 0 115 0 2.5 2.5 0 01-5 0z" clip-rule="evenodd" />
                                </svg>
                                Pencarian Cepat
                            </dt>
                            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                        ...
                        <div class="flex flex-col" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                                <p class="flex-auto">Atur arsip Anda dalam kategori yang terstruktur untuk pengelolaan yang lebih baik.</p>
                            </dd>
                        </div>
                    </dl>
                </div>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8" data-aos="zoom-in">
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-primary-100">
                        Sistem manajemen arsip digital yang aman, efisien, dan mudah digunakan.
                    </p>
            ...
            <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
                <div class="mt-8 md:order-1 md:mt-0">
                    <p class="text-center text-sm leading-5 text-gray-500">
                        &copy; {{ date('Y') }} Digital Arsip. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
